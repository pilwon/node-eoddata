    ...
    if (res.statusCode === 200) {
      xml2js.parseString(body, function (err, result) {
        ...
        if (!result.LOGINRESPONSE.$.Token) {
          return cb('Failed to login: ' + result.LOGINRESPONSE.$.Message);
        }
      ...
      return cb('Failed to login: status ' + res.statusCode);
    }
  });
};
...
Data.prototype.getCountryList = function (cb) {
  ...
  if (!_.isFunction(cb)) { cb = ultimate.callback.log; }
        ...
        if (res.statusCode === 200) {
          xml2js.parseString(body, function (err, result) {
            ...
            if (!result.RESPONSE.COUNTRIES) {
              return cb('Failed to get CountryList: ' + result.RESPONSE.$.Message);
            }
            var countries = {};
          ...
          return cb('Failed to get CountryList: status ' + res.statusCode);
        }
      });
    });
  }});
        ...
        if (res.statusCode === 200) {
          xml2js.parseString(body, function (err, result) {
            ...
            if (!result.RESPONSE.DATAFORMATS) {
              return cb('Failed to get DataFormats: ' + result.RESPONSE.$.Message);
            }
            var dataFormats = {};
          ...
          return cb('Failed to get DataFormats: status ' + res.statusCode);
        }
      });
    });
  }});
        ...
        if (res.statusCode === 200) {
          xml2js.parseString(body, function (err, result) {
            ...
            if (!result.RESPONSE.EXCHANGE) {
              return cb(util.format('Failed to get ExchangeGet (%s): %s',
          ...
          return cb(util.format('Failed to get ExchangeGet (%s): status %s',
        ...
        if (res.statusCode === 200) {
          xml2js.parseString(body, function (err, result) {
            ...
            if (!result.RESPONSE.EXCHANGES) {
              return cb('Failed to get ExchangeList: ' + result.RESPONSE.$.Message);
            }
            var exchanges = {};
          ...
          return cb('Failed to get ExchangeList: status ' + res.statusCode);
        }
      });
    });
  }});
        ...
        if (res.statusCode === 200) {
          xml2js.parseString(body, function (err, result) {
            ...
            if (!result.RESPONSE.FUNDAMENTALS) {
              return cb(util.format('Failed to get FundamentalList (%s): %s',
                                    exchangeCode, result.RESPONSE.$.Message).bold);
            }
            var fundamentals = {};
          ...
          return cb(util.format('Failed to get FundamentalList (%s): status %s',
                                exchangeCode, res.statusCode));
        }
      });
    });
        ...
        if (res.statusCode === 200) {
          xml2js.parseString(body, function (err, result) {
            ...
            if (!result.RESPONSE.QUOTE) {
              return cb(util.format('Failed to get QuoteGet (%s:%s): %s',
          ...
          return cb(util.format('Failed to get QuoteGet (%s:%s): status %s',
        ...
        if (res.statusCode === 200) {
          xml2js.parseString(body, function (err, result) {
            ...
            if (!result.RESPONSE.QUOTES) {
              return cb(util.format('Failed to get QuoteList (%s): %s',
          ...
          return cb(util.format('Failed to get QuoteList (%s): status %s',
                                exchangeCode, res.statusCode));
        }
      });
    });
      ...
      request.post({
        ...
        if (res.statusCode === 200) {
          xml2js.parseString(body, function (err, result) {
            if (err) { return cb(err); }
            if (!result.RESPONSE.QUOTES) {
              return cb(util.format('Failed to get QuoteList2 (%s:%s): %s',
                                    exchangeCode,
                                    symbolCodes.join(','),
          ...
          return cb(util.format('Failed to get QuoteList2 (%s:%s): status %s',
                                exchangeCode,
                                symbolCodes.join(','),
                                res.statusCode));
        }
      ...
      request.post({
        ...
        if (res.statusCode === 200) {
          xml2js.parseString(body, function (err, result) {
            if (err) { return cb(err); }
            if (!result.RESPONSE.QUOTES) {
              return cb(util.format('Failed to get QuoteListByDate (%s, %s): %s',
                                    exchangeCode,
          ...
          return cb(util.format('Failed to get QuoteListByDate (%s, %s): status %s',
                                exchangeCode,
                                moment(quoteDate).format('M/D/YYYY'),
                                res.statusCode));
        }
        ...
        if (res.statusCode === 200) {
          xml2js.parseString(body, function (err, result) {
            ...
            if (!result.RESPONSE.QUOTES2) {
              return cb(util.format('Failed to get QuoteListByDate2 (%s, %s): %s',
                                    exchangeCode,
                                    moment(quoteDate).format('M/D/YYYY'),
                                    result.RESPONSE.$.Message));
            }
          ...
          return cb(util.format('Failed to get QuoteListByDate2 (%s, %s): status %s',
                                exchangeCode,
                                moment(quoteDate).format('M/D/YYYY'),
                                res.statusCode));
        }
      ...
      request.post({
        ...
        if (res.statusCode === 200) {
          xml2js.parseString(body, function (err, result) {
            if (err) { return cb(err); }
            if (!result.RESPONSE.QUOTES) {
              return cb(util.format('Failed to get QuoteListByDatePeriod (%s, %s, %s): %s',
                                    exchangeCode,
                                    moment(quoteDate).format('M/D/YYYY'),
                                    period,
          ...
          return cb(util.format('Failed to get QuoteListByDatePeriod (%s, %s, %s): status %s',
                                exchangeCode,
                                moment(quoteDate).format('M/D/YYYY'),
                                period,
                                res.statusCode));
      ...
      request.post({
        ...
        if (res.statusCode === 200) {
          xml2js.parseString(body, function (err, result) {
            if (err) { return cb(err); }
            if (!result.RESPONSE.QUOTES2) {
              return cb(util.format('Failed to get QuoteListByDatePeriod2 (%s, %s, %s): %s',
                                    exchangeCode,
                                    moment(quoteDate).format('M/D/YYYY'),
                                    period,
                                    result.RESPONSE.$.Message).bold);
          ...
          return cb(util.format('Failed to get QuoteListByDatePeriod2 (%s, %s, %s): status %s',
                                exchangeCode,
                                moment(quoteDate).format('M/D/YYYY'),
                                period,
                                res.statusCode));
        ...
        if (res.statusCode === 200) {
          xml2js.parseString(body, function (err, result) {
            ...
            if (!result.RESPONSE.SPLITS) {
              return cb(util.format('Failed to get SplitListByExchange (%s): %s',
                                    exchangeCode, result.RESPONSE.$.Message).bold);
            }
            var splits = [];
          ...
          return cb(util.format('Failed to get SplitListByExchange (%s): status %s',
                                exchangeCode, res.statusCode));
        }
      });
    });
      ...
      request.post({
        ...
        if (res.statusCode === 200) {
          xml2js.parseString(body, function (err, result) {
            if (err) { return cb(err); }
            if (!result.RESPONSE.SPLITS) {
              return cb(util.format('Failed to get SplitListBySymbol (%s:%s): %s',
                                    exchangeCode, symbolCode, result.RESPONSE.$.Message).bold);
            }
            var splits = [];
            if (result.RESPONSE.SPLITS[0].SPLIT) {
          ...
          return cb(util.format('Failed to get SplitListBySymbol (%s:%s): status %s',
                                exchangeCode, symbolCode, res.statusCode));
        }
      });
    });
        ...
        if (res.statusCode === 200) {
          xml2js.parseString(body, function (err, result) {
            ...
            if (!result.RESPONSE.SYMBOLCHANGES) {
              return cb(util.format('Failed to get SymbolChangesByExchange (%s): %s',
                                    exchangeCode, result.RESPONSE.$.Message).bold);
            }
            var symbolChanges = [];
          ...
          return cb(util.format('Failed to get SymbolChangesByExchange (%s): status %s',
                                exchangeCode, res.statusCode));
        }
      });
    });
        ...
        if (res.statusCode === 200) {
          xml2js.parseString(body, function (err, result) {
            ...
            if (!result.RESPONSE.SYMBOL) {
              return cb(util.format('Failed to get SymbolGet (%s:%s): %s',
                                    exchangeCode, symbolCode, result.RESPONSE.$.Message).bold);
            }
          ...
          return cb(util.format('Failed to get SymbolGet (%s:%s): status %s',
                                exchangeCode, symbolCode, res.statusCode));
        }
      });
    });
      ...
      request.post({
        ...
        if (res.statusCode === 200) {
          xml2js.parseString(body, function (err, result) {
            if (err) { return cb(err); }
            if (!result.RESPONSE.QUOTES) {
              return cb(util.format('Failed to get SymbolHistory (%s:%s, %s-): %s',
                                    exchangeCode,
                                    symbolCode,
          ...
          return cb(util.format('Failed to get SymbolHistory (%s:%s, %s-): status %s',
                                exchangeCode,
                                symbolCode,
                                moment(startDate).format('M/D/YYYY'),
                                res.statusCode));
      ...
      request.post({
        ...
        if (res.statusCode === 200) {
          xml2js.parseString(body, function (err, result) {
            if (err) { return cb(err); }
            if (!result.RESPONSE.QUOTES) {
              return cb(util.format('Failed to get SymbolHistoryPeriod (%s:%s, %s, %s): %s',
                                    exchangeCode,
                                    symbolCode,
          ...
          return cb(util.format('Failed to get SymbolHistoryPeriod (%s:%s, %s, %s): status %s',
                                exchangeCode,
                                symbolCode,
                                moment(date).format('M/D/YYYY'),
                                period,
      ...
      request.post({
        ...
        if (res.statusCode === 200) {
          xml2js.parseString(body, function (err, result) {
            if (err) { return cb(err); }
            if (!result.RESPONSE.QUOTES) {
              return cb(util.format('Failed to get SymbolHistoryPeriodByDateRange (%s:%s, %s-%s, %s): %s',
                                    exchangeCode,
                                    symbolCode,
                                    moment(startDate).format('M/D/YYYY'),
          ...
          return cb(util.format('Failed to get SymbolHistoryPeriodByDateRange (%s:%s, %s-%s, %s): status %s',
                                exchangeCode,
                                symbolCode,
                                moment(startDate).format('M/D/YYYY'),
                                moment(endDate).format('M/D/YYYY'),
        ...
        if (res.statusCode === 200) {
          xml2js.parseString(body, function (err, result) {
            ...
            if (!result.RESPONSE.SYMBOLS2) {
              return cb(util.format('Failed to get SymbolList2 (%s): %s',
                                    exchangeCode,
                                    result.RESPONSE.$.Message).bold);
            }
            var symbols = {};
          ...
          return cb(util.format('Failed to get SymbolList2 (%s): status %s',
                                exchangeCode,
                                res.statusCode));
        }
      });
        ...
        if (res.statusCode === 200) {
          xml2js.parseString(body, function (err, result) {
            ...
            if (!result.RESPONSE.TECHNICALS) {
              return cb(util.format('Failed to get TechnicalList (%s): %s',
                                    exchangeCode,
                                    result.RESPONSE.$.Message).bold);
            }
            var technicals = {};
          ...
          return cb(util.format('Failed to get TechnicalList (%s): status %s',
                                exchangeCode,
                                res.statusCode));
        }
      });
      ...
      request.post({
        ...
        if (res.statusCode === 200) {
          xml2js.parseString(body, function (err, result) {
            if (err) { return cb(err); }
            if (!result.RESPONSE.QUOTES) {
              return cb(util.format('Failed to get Top10Gains (%s): %s',
                                    exchangeCode,
                                    result.RESPONSE.$.Message).bold);
            }
            var quotes = [];
          ...
          return cb(util.format('Failed to get Top10Gains (%s): status %s',
                                exchangeCode,
                                res.statusCode));
        }
      });
      ...
      request.post({
        ...
        if (res.statusCode === 200) {
          xml2js.parseString(body, function (err, result) {
            if (err) { return cb(err); }
            if (!result.RESPONSE.QUOTES) {
              return cb(util.format('Failed to get Top10Losses (%s): %s',
                                    exchangeCode,
                                    result.RESPONSE.$.Message).bold);
            }
            var quotes = [];
          ...
          return cb(util.format('Failed to get Top10Losses (%s): status %s',
                                exchangeCode,
                                res.statusCode));
        }
      });
