...
var _requestPost = Promise.promisify(request.post);
var _xml2jsParseString = Promise.promisify(xml2js.parseString);
...
function Data(config) {
  ...
  if (!_.isPlainObject(config)) { this._config = {} };
...
function _getToken(cb) {
  ...
  return _requestPost({
    ...
    if (res.statusCode === 200) {
      return _xml2jsParseString(body).then(function (result) {
...
function _requestWithToken(urlPath, form) {
  var _this = this;
        ...
        Promise.bind(_this)
          ...
          .then(function (token) {
            return _requestPost({
              ...
              next();
              if (res.statusCode === 200) {
                return _xml2jsParseString(body);
              } else {
...
Data.prototype.getDataFormats = function (cb) {
  ...
  this._taskQueue.push({run: function (next) {
    _getToken.call(_this, function (err, token) {
